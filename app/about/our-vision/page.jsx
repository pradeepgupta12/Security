...
//   title: "Our Vision | SS4 Security Management",
//   description: "SS4 Security Management vision for a secure and productive environment.",
// };
...
//           <p className="text-gray-600 text-sm leading-relaxed mb-8 anim">{vision.description}</p>
//           <blockquote className="border-l-4 border-red-600 pl-6 py-4 bg-red-50 rounded-r-lg anim">
