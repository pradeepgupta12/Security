...
//           {/* Our Clients box */}
//           <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-8 anim">
//             <h2 className="text-lg font-black uppercase red-line-center text-center mb-6">Our Clients</h2>
//             <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
//               {siteData.clients.slice(0, 8).map((name, i) => (
//                 <div key={i} className="bg-white border border-gray-200 rounded px-3 py-3 text-center hover:border-red-400 transition-colors">
