...
//               <div className="font-black text-sm">SS4 SECURITY</div>
//               <div className="text-[10px] text-gray-400">MANAGEMENT PVT. LTD.</div>
//             </div>
//           </div>
//           <p className="text-gray-400 text-xs leading-relaxed">{footer.description}</p>
//         </div>

//         {/* Registered Address */}
//         <div>
//           <h3 className="font-black text-xs uppercase tracking-widest mb-4 text-white">Registered Address</h3>
//           <div className="space-y-2 text-gray-400 text-xs">
//             <p className="flex gap-2"><span className="text-red-500 mt-0.5 flex-shrink-0">📍</span>{company.registeredAddress}</p>
//             <p className="font-bold text-white uppercase tracking-wide text-xs mt-3">Corporate Address</p>
//             <p className="flex gap-2"><span className="text-red-500 mt-0.5 flex-shrink-0">📍</span>{company.corporateAddress}</p>
//           </div>
//         </div>

//         {/* Contact */}
//         <div>
//           <h3 className="font-black text-xs uppercase tracking-widest mb-4 text-white">Contact Us</h3>
//           <div className="space-y-2 text-gray-400 text-xs">
//             {company.phone.map((p, i) => <p key={i} className="flex gap-2"><span className="text-red-500">📞</span>{p}</p>)}
//             <p className="flex gap-2"><span className="text-red-500">✉️</span>{company.email}</p>
//             <p className="flex gap-2"><span className="text-red-500">🕐</span>{company.hours}</p>
//           </div>
//         </div>

//         {/* Social / Find Us */}
//         <div>
//           <h3 className="font-black text-xs uppercase tracking-widest mb-4 text-white">Find Us In</h3>
...
//             <h4 className="font-black text-xs uppercase tracking-widest text-white mb-2">Quick Links</h4>
//             {[
...
//             ].map(l => (
//               <Link key={l.href} href={l.href} className="block text-gray-400 text-xs hover:text-red-400 transition-colors">
//                 › {l.label}
//               </Link>
//             ))}
//           </div>
