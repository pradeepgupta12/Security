          ...
          <div className="flex items-center justify-between h-10 md:h-16">
            ...
            <Link href="/" className="flex items-center flex-shrink-0">
              ...
              <div className="flex flex-col leading-tight select-none">
                {/* Line 1 — brand name */}
                <span
                  className="text-base md:text-xl font-extrabold tracking-tight text-gray-900"
                ...
                {/* Line 2 — descriptor */}
                <span
                  className="text-[9px] md:text-[11px] font-semibold italic tracking-wide"
